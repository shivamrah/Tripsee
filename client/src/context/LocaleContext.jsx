...
const TRANSLATIONS = {
    en: {
        ...
        pleaseSelectDate: "Please select a date for your trip.",
        pleaseSelectDeparture: "Please select a departure location.",
        pleaseChooseValidDate: "Please choose a valid future date.",
        ...
        // about/help/privacy
        aboutTitle: "About TripSee",
        aboutIntro: "TripSee is a lightweight trip discovery and booking demo application built to showcase a full-stack JavaScript travel booking experience.",
        whatThisProject: "What this project does",
        aboutFeature1: "Discover trips and attractions across states.",
        aboutFeature2: "Select seats and book tickets with a simple checkout flow.",
        aboutFeature3: "View and manage your bookings in a dedicated My Bookings view.",
        aboutFeature4: "Admin dashboard for creating and managing trips and viewing bookings.",
        helpResponseTime: "Typical response time: 1 business day.",
        helpIntro: "If you need assistance, we are here to help. Below are the best ways to reach us.",
        ...
        techStackText: "Frontend: React + Vite. Backend: Node.js, Express. Database: MongoDB. Images handled via Cloudinary. Authentication uses JWT.",
        whyText: "This project demonstrates a concise, practical travel booking flow with a focus on maintainability, simple APIs, and a responsive UI.",
        contactTitle: "Contact",
        contactHelpLinkText: "If you need help or want to contribute, see the Help Center.",
        helpCenter: "Help Center",
        helpSupportTitle: "TripSee — Trusted travel and trip booking service.",
        helpContactHint: "Include your booking ID and a short description when contacting support.",
        privacyList1: "Booking information including trip selections, seats, travel dates and payment metadata.",
        privacyList2: "To provide and operate the booking service and process bookings.",
        privacyTitle: "Privacy Policy",
        privacyLead: "This Privacy Policy explains how TripSee collects, uses, discloses, and protects your personal information.",
        // generic UI
        cancel: "Cancel",
        remove: "Remove",
        ok: "OK",
